...
int rules(int left, int middle, int rigth)
{
  ...
  if (left == 0 && middle == 0 && rigth == 0) return ruleset[7];
  else if (left == 0 && middle == 0 && rigth == 1) return ruleset[6];
  else if (left == 0 && middle == 1 && rigth == 0) return ruleset[5];
  else if (left == 0 && middle == 1 && rigth == 1) return ruleset[4];
  else if (left == 1 && middle == 0 && rigth == 0) return ruleset[3];
  else if (left == 1 && middle == 0 && rigth == 1) return ruleset[2];
  else if (left == 1 && middle == 1 && rigth == 0) return ruleset[1];
  else if (left == 1 && middle == 1 && rigth == 1) return ruleset[0];
