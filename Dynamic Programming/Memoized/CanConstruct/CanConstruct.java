...
public class CanConstruct
{
	public static void main(String[] args) 
	{
		...
		System.out.println("Can " + Arrays.toString(strArray) + " construct '" + target + "': " + canConstruct(target, strArray));
		// String end = "ciple";
		// int n = end.length();
	...
	*/
	public static Boolean canConstruct(String target, String[] strArray)
	{
		if(target.equals("")) return true;

		for(String str : strArray)
		{
			if(hasEnd(target, str)) return canConstruct(removeEnd(target, str.length()), strArray);
		}
